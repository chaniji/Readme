---
title: "Manavarya09/design-extract: Extract any website's complete design system with one command. DTCG tokens, semantic+primitive+composite, MCP server for Claude Code/Cursor/Windsurf, multi-platform emitters (iOS SwiftUI, Android Compose, Flutter, WordPress), Tailwind v4, Figma variables, shadcn/ui, CSS health audit, WCAG remediation, Chrome extension. MIT, Playwright, Node 20+."
source: "https://github.com/Manavarya09/design-extract"
author:
published:
created: 2026-05-14
description: "Extract any website's complete design system with one command. DTCG tokens, semantic+primitive+composite, MCP server for Claude Code/Cursor/Windsurf, multi-platform emitters (iOS SwiftUI, Android Compose, Flutter, WordPress), Tailwind v4, Figma variables, shadcn/ui, CSS health audit, WCAG remediation, Chrome extension. MIT, Playwright, Node 20+. - Manavarya09/design-extract"
tags:
  - "clippings"
---
[![designlang — reads a website the way a developer reads a stylesheet](https://github.com/Manavarya09/design-extract/raw/main/website/public/logo-specimen.svg)](https://github.com/Manavarya09/design-extract/blob/main/website/public/logo-specimen.svg)

---

[![designlang in action](https://github.com/Manavarya09/design-extract/raw/main/designlang.png)](https://github.com/Manavarya09/design-extract/blob/main/designlang.png)

[![designlang on npm](https://camo.githubusercontent.com/08d0a35f129aff40ee113cedd9d337e4e994df65babae53de5ec15981174a60e/68747470733a2f2f706b67666f6c696f2e76657263656c2e6170702f656d6265642f706b672f64657369676e6c616e673f763d32)](https://www.npmjs.com/package/designlang)
...
| **VS Code extension** | [`vscode-extension/`](https://github.com/Manavarya09/design-extract/blob/main/vscode-extension) | "Extract design from URL" command + auto-inject into workspace. |
| **Raycast extension** | [`raycast-extension/`](https://github.com/Manavarya09/design-extract/blob/main/raycast-extension) | Extract, score, and "copy CLI command" from Raycast. |
| **Figma plugin** | [`figma-plugin/`](https://github.com/Manavarya09/design-extract/blob/main/figma-plugin) | Paste a URL inside Figma, get a full Variables collection. |
| **GitHub Action** | [`github-action/`](https://github.com/Manavarya09/design-extract/blob/main/github-action) | "Design regression guard" — diffs tokens on every PR and comments. |
| **Chrome extension** | [`chrome-extension/`](https://github.com/Manavarya09/design-extract/blob/main/chrome-extension) | One-click handoff from any tab (MV3, `activeTab` only). |
| **MCP server** | `npx designlang mcp` | Exposes the extracted design as MCP resources + tools for Cursor, Claude Code, Windsurf, etc. See [`docs/MCP-REGISTRY.md`](https://github.com/Manavarya09/design-extract/blob/main/docs/MCP-REGISTRY.md). |
| **Claude Code plugin** | [`.claude-plugin/`](https://github.com/Manavarya09/design-extract/blob/main/.claude-plugin) | Five slash commands inside Claude Code — `/extract`, `/grade`, `/battle`, `/remix`, `/pack`. |
...
Manifest: [`.claude-plugin/plugin.json`](https://github.com/Manavarya09/design-extract/blob/main/.claude-plugin/plugin.json) · marketplace: [`.claude-plugin/marketplace.json`](https://github.com/Manavarya09/design-extract/blob/main/.claude-plugin/marketplace.json) · commands: [`commands/`](https://github.com/Manavarya09/design-extract/blob/main/commands) · skills: [`skills/`](https://github.com/Manavarya09/design-extract/blob/main/skills).
...
See [CONTRIBUTING.md](https://github.com/Manavarya09/design-extract/blob/main/CONTRIBUTING.md). PRs welcome!

## License

[MIT](https://github.com/Manavarya09/design-extract/blob/main/LICENSE) - Manav Arya Singh