...
<main class="wp-block-group"><!-- wp:query {"queryId":0,"query":{"perPage":"100","pages":0,"offset":"0","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"layout":{"type":"default"}} -->
...
<!-- wp:query-pagination-previous {"label":"<?php echo esc_html__( 'Previous', 'perenne' ); ?>"} /-->
